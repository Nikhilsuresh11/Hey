...
def sendmail(to,content):
    ...
    server.ehlo()
    server.starttls()
    server.login("nikhilsuresh86@gmail.com","sribalaaji")
    server.sendmail("nikhilsuresh86@gmail.com",to,content)
    server.close()
...
def runAlexa():
    ...
    if "time" in query:
            ...
            chromepath = "C:\ProgramData\Microsoft\Windows\Start Menu\Programs %s"
            ...
            speak("I am sara ! Your virtual voice assisstant what do you need bitch ?")
